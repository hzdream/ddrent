...
public class RSA {
	...
	public static final String PARAMS_ENCRYPTKEY = "encryptkey";
	public static final String PARAMS_APPID = "appId";
	public static Map<String, Object> handlParams(TreeMap<String, Object> params, String clientPubKey, String myPriKey, String appId) {
		try {
			// 生成RSA签名
			String sign = EncryUtil.handleRSA(params, myPriKey);
			...
			String encryptkey;
			encryptkey = RSA.encrypt(aesKey, clientPubKey);
			Map<String, Object> reqParams = new HashMap<>();
			reqParams.put(PARAMS_DATA, data);
			reqParams.put(PARAMS_ENCRYPTKEY, encryptkey);
			reqParams.put(PARAMS_APPID, appId);
			return reqParams;
		} catch (Exception e) {
			logger.error("RSA.handlParams error", e);;
		}
