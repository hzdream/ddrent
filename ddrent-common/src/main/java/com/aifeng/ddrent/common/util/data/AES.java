...
public class AES {
	...
	public static String encrypt(String data, String key) throws UnsupportedEncodingException {
		...
		String value = new String(valueByte, "ISO-8859-1");
		return value;
	}
	...
	public static String decrypt3(String data, String key) throws UnsupportedEncodingException{
		byte[] originalData = data.getBytes("ISO-8859-1");
		byte[] valueByte = decrypt(originalData, key.getBytes(ConfigureEncryptAndDecrypt.CHAR_ENCODING));
		return new String(valueByte, ConfigureEncryptAndDecrypt.CHAR_ENCODING);
